...
public class Channel extends BaseType {
	...
	public Channel(Channel oOther){
		super(oOther);
		
		_strFormat = oOther._strFormat;
		_strActualValue = new String(oOther._strActualValue);
		_strActualValueDisplay = new String(oOther._strActualValueDisplay);
	
	}
	public Channel(Element oElement){
		this(oElement, null);
		_oElement = oElement;
	...
	public Channel(Element oElement, Object oObj){
		super(oElement, oObj);
	...
	boolean validateChannel(String strChannel){
	...
	public int signal(BusMessage oMessage) {	
		...
		if(_oKeySet.contains(oMessage.getButtonEvent().getKeyId())){
			...
			if(_strActualValue.length() < _strFormat.length()){
				...
				if(validateChannel(_strActualValue + newValue)){		
	...
	public boolean isValid() {	
		return validateChannel(_strActualValue);
	}
	...
	public void setValue(ActiveField oValue) {
		...
		if(oValue instanceof Channel){
			
			Channel src = (Channel)oValue;
			
			_strActualValue = src._strActualValue;
			_strActualValueDisplay = src._strActualValueDisplay;
