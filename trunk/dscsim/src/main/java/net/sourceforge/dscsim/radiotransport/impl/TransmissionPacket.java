 ...
 *
 */
public class TransmissionPacket implements Cloneable {
	 ...
	 */
	public static TransmissionPacket fromByteArray(byte[] src, int offset ){
		...
		TransmissionPacket result = new TransmissionPacket();
